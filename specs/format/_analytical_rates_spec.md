...
[`RhsOde`](../bp_format/mechanistic.py) (i.e. on a `BioProcess` whose
[`biological_ode`](../bp_format/dataclasses.py) block is set, either
user-supplied or auto-generated by `BioProcess.__post_init__`).
